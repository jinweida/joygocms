...
router.get('/'+V+'/api/lives/get_my_lives',lives.get_my_lives);
...
//广播
router.get('/'+V+'/api/get_broadcasts',ios.up,lives.get_broadcasts);
router.get('/'+V+'/api/get_broadprograms',ios.up,lives.get_broadprograms);
router.get('/'+V+'/api/get_broadcasts_detail',ios.up,lives.get_broadcasts_detail);
router.get('/'+V+'/api/get_utc_time',lives.get_utc_time);
router.post('/'+V+'/api/set_broadcasts_assist',lives.set_broadcasts_assist);
//导播回复
router.post('/'+V+'/api/director_message',lives.director_message);
