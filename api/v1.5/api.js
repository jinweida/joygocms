...
//====================================================
//新活动
router.get('/'+V+'/api/get_hostair',apis.get_hostair);
router.get('/'+V+'/api/get_associated',apis.get_associated);
router.get('/'+V+'/api/get_regtemplate',apis.get_regtemplate);
router.post('/'+V+'/api/set_registration',apis.set_registration);
router.get('/'+V+'/api/payment_registration',apis.payment_registration);
router.get('/'+V+'/api/get_registrationrecord',apis.get_registrationrecord);
router.get('/'+V+'/api/get_registrationrecord_detail',apis.get_registrationrecord_detail);
router.get('/'+V+'/api/get_registration',apis.get_registration);
router.post('/'+V+'/api/set_vouchers',apis.set_vouchers);
//获取绩效
//***************************写入*****************************************
//测试post
