...
exports.set=function(req,res,next){
  ...
  }else if(/api\/lives\/get_detail\/{0,1}$/g.test(model.path)){
    console.log('livesdetail')
    model.type=1;
    model.cid=0;
...
exports.get_statistics=function(req,res){
  ...
  Statistics.count({mid:_id},function(err,count){
    count=count+''
    response.apidetail(res, {}, {count:count})
  })
}